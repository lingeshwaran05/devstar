    ...
    <body>
        ...
        >
            ...
            <div class="nav-bar bg-gray-200 p-2 flex items-center">
                ...
                <div class="relative">
                    ...
                    <div id="shapes-dropdown" class="dropdown">
                        <div class="dropdown-item" data-shape="circle">
                            <img src="/src/images/circle2.png" alt="" />
                        </div>
                        <div class="dropdown-item" data-shape="square">
                            <img src="/src/images/square.png" alt="" />
                        </div>
                        <div class="dropdown-item" data-shape="triangle">
                            <img src="/src/images/triangle.png" alt="" />
                        </div>
                        <div class="dropdown-item" data-shape="rectangle">
                            <img src="/src/images/rectangle.png" alt="" />
                        </div>
                        <div class="dropdown-item" data-shape="line">
                            <img src="/src/images/line.png" alt="" />
                        </div>
                    </div>
                </div>
                ...
                >
                <button id="download" class="tool-btn"
                    ><img
                        src="/src/images/downloads.png"
                        alt="Download"
                    /></button
                >
                ...
                function floodFill(x, y, fillColor) {
                    ...
                    if (!colorsMatch(targetColor, fillColor)) {
                        ...
                        while (stack.length > 0) {
                            ...
                            const currentColor = getColorAtPixel(
                                imageData,
                                currentX,
                                currentY
                            );
